        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="bg-gray-800/50 rounded-lg p-8 border border-gray-700">
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-6">
              I use Python primarily to build and optimise production pipelines.
              I automate repetitive tasks, create custom tools for artists, and integrate
              different applications into a unified workflow — significantly speeding up
            ...
            <div className="bg-gradient-to-r from-blue-900/20 to-blue-800/20 rounded-lg p-6 mb-6 border border-blue-700/30">
              ...
              <p className="text-gray-300">
                I write scripts and tools that automate repetitive tasks, manage project files,
                and ensure smooth communication between different applications in the VFX pipeline.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#c770f0]">Integrations:</h3>
                <ul className="space-y-2 text-gray-300">
